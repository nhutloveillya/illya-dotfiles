...
-- finds magnet: anywhere in the string and returns everything from that point onward
function extract_url(url)
   local start = url:find("magnet:", 1, true)
   if start and start > 1 then
      return url:sub(start)
   end
   return url
end
